...
public class CustomerDoTurnoverMenu implements Menu {
    ...
    private Turnover requirementCheck() {
        ...
        while (!check) {
            ...
            if (ApplicationContext.getInstance().getBankAccountRepository().findCard(sCard) == null)
        ...
        while (!check) {
            ...
            if (ApplicationContext.getInstance().getBankAccountRepository().findCard(dCard) == null)
